...
from api.view import region, pay_details, auth, customer, payment, product, deal, workplace
...
urlpatterns = [
    ...
    path('get/workplaces/<str:smartup_id>/', workplace.WorkPlaceDetailView.as_view(), name='workplace-detail'),
]
